            ...
            <ul className="mt-12">
              <li>
                <button
                  ...
                  type="button"
                  class="flex items-center  bg-gray-700 p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
